...
public class Annotation extends ComponentBase {
    ...
    /** label string that is drawn next to the Annotation line */
    ...
    public Annotation(float value, String label) {
        mValue = value;
        mLabel = label;
    }
    ...
    /**
     * Sets the label that is drawn next to the annotation.
     *
     * @param label
     */
    ...
    public void updateAnnotationValue(float newValue) {
        mValue = newValue;
        mLabel = String.valueOf(newValue);
    }
}
